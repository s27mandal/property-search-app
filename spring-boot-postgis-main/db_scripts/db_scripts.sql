...
VALUES (1, 'Vadapalani', 'SRID=4326;POINT(80.211533 13.052570)', 'Property1', '2bhk', ROUND(RANDOM() * 2000000 + 1000000), ROUND(RANDOM() * 2000 + 1000));

INSERT INTO properties (property_id, city_name, property_location, property_name, property_type, price, area)
VALUES (2, 'Kodambakkam', 'SRID=4326;POINT(80.230737 13.051090)', 'Property2', '3bhk', ROUND(RANDOM() * 2000000 + 1000000), ROUND(RANDOM() * 2000 + 1000));

INSERT INTO properties (property_id, city_name, property_location, property_name, property_type, price, area)
VALUES (3, 'West Mambalam', 'SRID=4326;POINT(80.229347 13.042449)', 'Property3', '2bhk', ROUND(RANDOM() * 2000000 + 1000000), ROUND(RANDOM() * 2000 + 1000));

INSERT INTO properties (property_id, city_name, property_location, property_name, property_type, price, area)
VALUES (4, 'Mambalam', 'SRID=4326;POINT(80.227887 13.036763)', 'Property4', '3bhk', ROUND(RANDOM() * 2000000 + 1000000), ROUND(RANDOM() * 2000 + 1000));
